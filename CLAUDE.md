...
- `docs/FORMAT.md` — **authoritative** spec of the on-disk format and the CLI surface.
  Every syntax or semantics decision is written there as it is made. If FORMAT.md and
  the code disagree, that is a bug.
